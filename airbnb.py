...
st.set_page_config(page_title= "Airbnb Data Visualization | By Aravinth",
                   page_icon= icon,
                   layout= "wide",
...
client = pymongo.MongoClient("mongodb+srv://aravinth:aravinth1234@cluster0.duefcos.mongodb.net/?retryWrites=true&w=majority")
